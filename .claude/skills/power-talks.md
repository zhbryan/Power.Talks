---
name: power-talks
description: Power.Talks project assistant. Saves front-end code to "html/", database code to "Database Codes/", and downloaded documents to "Documents Database/". Invoke when working in the Power.Talks project.
...
| Downloaded/fetched documents from the internet (PDFs, articles, reports, etc.) | `Documents Database/` |
