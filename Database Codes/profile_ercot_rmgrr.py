#!/usr/bin/env python3
"""
ERCOT RMGRR Profile Creator
Implements the ERCOT Market Rules Profile skill for all RMGRR issues.
...
EXCEL_TRACKER = os.path.join(BASE_DIR, "Current List of RMGRRs.xlsx")
...
def extract_fields_from_tables(tables):
    ...
    for row in tables[0]:
        for i, cell in enumerate(row):
            ...
            elif 'retail market guide sections' in cl or 'sections requiring' in cl or 'retail market' in cl:
